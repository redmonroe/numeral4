...
from sqlalchemy.orm import Query, relationship, sessionmaker, with_polymorphic
...
#  I CAN use context manager for session
...
class Pagination(object):
    """Internal helper class returned by :meth:`Query.paginate`.  You
